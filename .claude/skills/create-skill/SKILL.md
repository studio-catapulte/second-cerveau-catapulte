...
- **Skill seul** : fichier `.claude/skills/[nom]/SKILL.md`. L'IA peut l'exécuter avec /[nom]
- **Fiche seule** : `4 TOOLS/Process/Process - [Nom].md`. Référence humaine lisible, pas d'exécution IA
...
Crée `.claude/skills/[nom]/SKILL.md` avec ce squelette (adapté à la méthode capturée) :
...
## Références
- [[Process - Nom]] : fiche process associée dans `4 TOOLS/Process/`
...
Crée `4 TOOLS/Process/Process - [Nom].md` :
...
Si `4 TOOLS/Process/Cartographie des process.md` existe, ajoute le nouveau process dans la bonne section (Daily / Weekly / Monthly / Trigger / Manuel).
