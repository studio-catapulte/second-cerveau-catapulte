...
1. Lis `2 CASQUETTES/Sur ma vie/Moi.md` pour comprendre qui est l'utilisateur
2. Vérifie si `4 TOOLS/Process/Cartographie des process.md` existe déjà
...
1. Crée `4 TOOLS/Process/Cartographie des process.md` avec la vue d'ensemble :
