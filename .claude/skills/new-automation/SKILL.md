...
1. Lis `2 CASQUETTES/Sur ma vie/Moi.md` et la phase active pour le contexte utilisateur
2. Si un process est mentionné, lis sa fiche dans `4 TOOLS/Process/`
...
Si c'est une nouvelle automatisation standalone, crée `3 RESSOURCES/Automatisations/Automatisation - [Nom].md` (créer le dossier `Automatisations/` s'il n'existe pas) :
