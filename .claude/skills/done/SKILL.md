...
- Chemin : `2 CASQUETTES/Sur ma vie/Life Phases/[Phase active]/[YYYY-MM-DD].md`
- Si elle n'existe pas, crée-la avec le template `4 TOOLS/Templates/Daily Note.md`
...
3. **Mets à jour directement** la note :
   - `1 PROJETS/[Projet]/[Projet].md` → Progression, roadmap, statut
   - `2 CASQUETTES/[Casquette]/[Casquette].md` → Nouvelles infos, responsabilités
...
- `2 CASQUETTES/Sur ma vie/Moi.md` → Style IA, valeurs, nouvelles infos personnelles
