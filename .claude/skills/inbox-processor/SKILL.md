...
L'inbox (`0 INBOX/`) est un point de capture temporaire. Les notes ne doivent pas y rester plus de quelques jours.

## Avant de commencer

1. Lis le contexte de l'utilisateur :
   - `2 CASQUETTES/Sur ma vie/Moi.md`
   - Intention de la phase active (détectée dans `2 CASQUETTES/Sur ma vie/Life Phases/`)
2. Liste les projets actifs (`1 PROJETS/*/`) et casquettes (`2 CASQUETTES/*/`)
...
Liste tous les fichiers dans `0 INBOX/` :
...
**Actions possibles :**
1. → Transformer en projet (`1 PROJETS/`)
2. → Rattacher à une casquette (`2 CASQUETTES/`)
3. → Classer en ressource (`3 RESSOURCES/`)
4. → Archiver (`5 ARCHIVE/`)
